...
export default function ExecutiveStoryPanel({ data, period }: { data: DashboardData; property: string; period: 'm' | 'y' | 'a' }) {
  const sentences = buildExecutiveNarrative(data, period)
  return (
    <Card
      sx={{
        mb: 1.5,
